                    ...
                    <table class="min-w-full table-auto">
                        <thead class="justify-between">
                            <tr class="bg-gray-800">
                                <th class="px-4 py-2 text-gray-300">No.</th>
                                <th class="px-16 py-2 text-gray-300">Name</th>
                                <th class="px-16 py-2 text-gray-300">Action</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr v-for=" category in categories" :key="category.id" class="bg-white border-0 border-gray-200">
                                ...
                                <td class="px-4 py-2 text-center">
                                    <div class="flex item-center justify-center">
                                        ...
                                        <Link @click="destroy(category.id)">                                        
